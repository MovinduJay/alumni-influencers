...
$route['api/v1/auth/register'] = 'api/auth_register';
$route['api/v1/auth/verify'] = 'api/auth_verify';
$route['api/v1/auth/forgot-password'] = 'api/auth_forgot_password';
$route['api/v1/auth/reset-password'] = 'api/auth_reset_password';
$route['api/v1/auth/login'] = 'api/auth_login';
$route['api/v1/auth/me'] = 'api/auth_me';
$route['api/v1/auth/logout'] = 'api/auth_logout';
$route['api/v1/me/profile'] = 'api/profile_me';
$route['api/v1/me/profile/image'] = 'api/profile_image_upload';
$route['api/v1/me/degrees'] = 'api/degrees';
$route['api/v1/me/degrees/(:num)'] = 'api/degree_item/$1';
$route['api/v1/me/certifications'] = 'api/certifications';
$route['api/v1/me/certifications/(:num)'] = 'api/certification_item/$1';
$route['api/v1/me/licences'] = 'api/licences';
$route['api/v1/me/licences/(:num)'] = 'api/licence_item/$1';
$route['api/v1/me/courses'] = 'api/courses';
$route['api/v1/me/courses/(:num)'] = 'api/course_item/$1';
$route['api/v1/me/employment'] = 'api/employment';
$route['api/v1/me/employment/(:num)'] = 'api/employment_item/$1';
$route['api/v1/me/bidding'] = 'api/bidding_dashboard';
$route['api/v1/me/bids'] = 'api/bids';
$route['api/v1/me/bids/(:num)'] = 'api/bid_item/$1';
$route['api/v1/me/sponsorships'] = 'api/sponsorships';
$route['api/v1/me/sponsorships/(:num)'] = 'api/sponsorship_item/$1';
$route['api/v1/me/events'] = 'api/events';
$route['api/v1/me/events/(:num)'] = 'api/event_item/$1';
$route['api/v1/admin/api-clients'] = 'api/admin_api_clients';
