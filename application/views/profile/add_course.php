<div class="row justify-content-center">
    <div class="col-md-8">
        <div class="card">
            <div class="card-header"><h4 class="mb-0"><i class="fas fa-plus"></i> Add Course</h4></div>
            <div class="card-body">
                <?php echo form_open('profile/courses/add'); ?>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control <?php echo form_error('provider') ? 'is-invalid' : ''; ?>" id="provider" name="provider" value="<?php echo set_value('provider'); ?>" required>
                        <div class="invalid-feedback"><?php echo form_error('provider'); ?></div>
                    </div>
                    <div class="mb-3">
