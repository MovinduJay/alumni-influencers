<div class="row justify-content-center">
    <div class="col-md-8">
        <div class="card">
            <div class="card-header"><h4 class="mb-0"><i class="fas fa-plus"></i> Add Degree</h4></div>
            <div class="card-body">
                <?php echo form_open('profile/degrees/add'); ?>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control <?php echo form_error('institution') ? 'is-invalid' : ''; ?>" id="institution" name="institution" value="<?php echo set_value('institution'); ?>" required>
                        <div class="invalid-feedback"><?php echo form_error('institution'); ?></div>
                    </div>
                    <div class="mb-3">
                        <label for="url" class="form-label">URL (to official degree page)</label>
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <button type="submit" class="btn btn-primary"><i class="fas fa-save"></i> Save Degree</button>
                    </div>
                <?php echo form_close(); ?>
            </div>
        </div>
